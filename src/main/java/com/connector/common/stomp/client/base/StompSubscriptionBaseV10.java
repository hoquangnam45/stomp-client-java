...
public class StompSubscriptionBaseV10<StompConnectConfig extends StompConnectConfigV10, StompDisconnectConfig, StompSessionInfo extends StompSessionInfoV10, TransportReq, TransportResp> extends StompSubscriptionBase<StompConnectConfig, StompDisconnectConfig, StompSessionInfo, TransportReq, TransportResp>
{
    public StompSubscriptionBaseV10(String destination, String id, StompAckMode ackMode, IStompClient<StompConnectConfig, StompDisconnectConfig, StompSessionInfo, TransportReq, TransportResp> stompClient)
    {
